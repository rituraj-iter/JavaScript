function run() {
    ...
    if (gender == 'm') {
        document.getElementById("image").src = "https://joeschmoe.io/api/v1/male/" + name;
    }
    else if (gender == 'f') {
        document.getElementById("image").src = "https://joeschmoe.io/api/v1/female/" + name;
    }
    else {
        document.getElementById("image").src = "https://joeschmoe.io/api/v1/" + name;
    }
